...
describe('helpers: detectProvider / convertProviderToEvalResult', () => {
  ...
  it('detects openai-compatible and converts', () => {
    const start = Date.now(); const end = start + 1000;
  ...
  it('detects bedrock and converts', () => {
    const start = Date.now(); const end = start + 1000;
  ...
  it('detects vertex and converts', () => {
    const start = Date.now(); const end = start + 1000;
  ...
  it('detects anthropic and converts', () => {
    const start = Date.now(); const end = start + 1000;
  ...
  it('detects cohere and converts', () => {
    const start = Date.now(); const end = start + 1000;
  ...
  it('detects ollama and converts', () => {
    const start = Date.now(); const end = start + 1000;
